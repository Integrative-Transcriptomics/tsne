...
d <- read.csv('diss/datasets/Thcells/GSE2770_GPL97_log_qnorm_sorted.txt', sep = '\t', header = 1)
...
write.csv(selected_genes_m, 'diss/datasets/Thcells/selected_data.txt', row.names = FALSE)
write.csv(mean, 'diss/datasets/Thcells/mean.txt', row.names = FALSE)
write.csv(a_cor_est, 'diss/datasets/Thcells/cov1.txt', row.names = FALSE)
write.csv(g_cor_est, 'diss/datasets/Thcells/cov2.txt', row.names = FALSE)
